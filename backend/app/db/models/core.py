...
class Node(Base, TimestampMixin):
    ...
    owner_user_ids: Mapped[list[int]] = mapped_column(JSON, default=list)
    access_scope: Mapped[str] = mapped_column(String(32), default="public", index=True)
...
class Task(Base, TimestampMixin):
    ...
    generated_command: Mapped[str] = mapped_column(Text, default="")
    ...
    last_block_reason: Mapped[str] = mapped_column(String(512), default="")
